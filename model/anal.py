...
def click(a):
    if a>0:
        ...
        dbc.Row(
        [
           dbc.Col(dbc.Button(html.Img(src=app.get_asset_url('warriorii_2o.jpg'), style={'height':'22rem', 'width':'22rem',"bottom": 2}), color="light",id="warriorwew2", className="m-1",n_clicks_timestamp=1),width=5),
        ...
        return [dbc.Row(
    [
        dbc.Col(dbc.Button(html.Img(src='https://github.com/niharika412/pose_coach/blob/master/images/warriorii_2.jpg?raw=true', style={'height':'22rem', 'width':'22rem',"bottom": 2}), color="light",id="warrior2", className="m-1",n_clicks_timestamp=1),width=5),
        dbc.Col(dbc.Button(id="output-image-upload" ,color="light", className="m-1"),width=5),
    ],
    justify='center'),
    dbc.Row(
            [
